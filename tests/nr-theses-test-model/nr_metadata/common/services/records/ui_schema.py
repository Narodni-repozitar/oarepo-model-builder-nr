...
class AdditionalTitlesUISchema(ma.Schema):
    ...
    titleType = l10n.LocalizedEnum(value_prefix="nr_theses_test_model")
...
class NRAuthorityIdentifierUISchema(ma.Schema):
    ...
    scheme = l10n.LocalizedEnum(value_prefix="nr_theses_test_model")
...
class NRAuthorityUIUISchema(ma.Schema):
    ...
    nameType = l10n.LocalizedEnum(value_prefix="nr_theses_test_model")
