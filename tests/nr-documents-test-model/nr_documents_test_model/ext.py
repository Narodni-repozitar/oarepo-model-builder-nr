...
class Nr_documents_test_modelExt:
    ...
    def service_records(self):
        return config.NR_DOCUMENTS_TEST_MODEL_RECORD_SERVICE_CLASS(
            config=config.NR_DOCUMENTS_TEST_MODEL_RECORD_SERVICE_CONFIG(),
        )

    @cached_property
    def resource_records(self):
        return config.NR_DOCUMENTS_TEST_MODEL_RECORD_RESOURCE_CLASS(
            service=self.service_records,
            config=config.NR_DOCUMENTS_TEST_MODEL_RECORD_RESOURCE_CONFIG(),
        )
